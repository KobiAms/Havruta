...
import { Text, StyleSheet, TouchableOpacity, View, Dimensions, TextInput, ActivityIndicator, FlatList } from 'react-native';
    ...
    UserItem = ({ headline, color, onPress }) => {
        return (
            <TouchableOpacity style={styles.item} onPress={onPress}>
                ...
                <Text>{headline}</Text>
                <Icon2 style={styles.arrow_right} name={"right"} size={20} color={'gray'} />
            </TouchableOpacity>
        )
    }
            ...
            <View style={styles.body}>
                <View style={styles.search_container}>
                    <TextInput
                        ...
                        onChangeText={(text) => {
                            setShow(users.filter(item => item.email.toLowerCase().includes(text.toLowerCase())))
                            setFilter(text)
                        }}
                        value={filter}
                    />
